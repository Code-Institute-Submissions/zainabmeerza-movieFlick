...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'milestone4/movieflick/milestone4/milestone4/templates' )],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [ 
    os.path.join(BASE_DIR, 'milestone4/movieflick/milestone4/milestone4/static')
]
